...
{
    public partial class Paishui_subview : UserControl
    {
        ...
        public void init_view()
        {
            ...
            comboBox_jinshuizhonglei.Items.Add("机缸排水一");
            comboBox_jinshuizhonglei.Items.Add("机缸排水二");
            comboBox_jinshuizhonglei.Items.Add("机缸排水三");
            comboBox_jinshuizhonglei.Items.Add("机缸排水四");
            comboBox_jinshuizhonglei.Items.Add("停泵排水一");
            comboBox_jinshuizhonglei.Items.Add("停泵排水二");
            comboBox_jinshuizhonglei.Items.Add("停泵排水三");
            comboBox_jinshuizhonglei.Items.Add("停泵排水四");
        }
