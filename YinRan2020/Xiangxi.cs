...
namespace YinRan2020
{
    public partial class Xiangxi : Form
    {
        ...
        public void init_view()
        {
            ...
            ViewCaoZuo.Object_Position(0.78, 0.53, 0.2, 0.05, label_no2, this.Controls);

            ViewCaoZuo.Object_Position(0.78, 0.56, 0.2, 0.05, label_no3, this.Controls);

            ViewCaoZuo.Object_Position(0.8, 0.5, 0.2, 0.05, comboBox1, this.Controls);

            ViewCaoZuo.Object_Position(0.8, 0.53, 0.2, 0.05, comboBox2, this.Controls);

            ViewCaoZuo.Object_Position(0.8, 0.56, 0.2, 0.05, comboBox3, this.Controls);
